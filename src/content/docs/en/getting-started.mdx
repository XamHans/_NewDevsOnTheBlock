...
- **Create a profile** remeber that our mission to connect you with web3 developers. But we can only do this if you have a profile. So [create one now here](https://lli3ozyo8v6.typeform.com/to/YBaPEVOf). After reviewing your profile, you will be listed on our [community app](https://ndob-nextjs.vercel.app/).
